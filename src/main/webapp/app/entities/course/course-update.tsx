  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="studentManagementApplicationApp.course.home.createOrEditLabel" data-cy="CourseCreateUpdateHeading">
            <Translate contentKey="studentManagementApplicationApp.course.home.createOrEditLabel">Create or edit a Course</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('studentManagementApplicationApp.course.courseName')}
