...
export const CourseDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="studentManagementApplicationApp.course.delete.question">
        <Translate contentKey="studentManagementApplicationApp.course.delete.question" interpolate={{ id: courseEntity.id }}>
