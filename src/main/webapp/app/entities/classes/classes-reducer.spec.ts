...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './classes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASSES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLASSES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLASSES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CLASSES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CLASSES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLASSES actions', async () => {
      const arg = 42666;
