...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLETIME_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TABLETIME actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TABLETIME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TABLETIME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TABLETIME actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TABLETIME actions', async () => {
      const arg = 42666;
