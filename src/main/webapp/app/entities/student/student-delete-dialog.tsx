...
export const StudentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="studentManagementApplicationApp.student.delete.question">
        <Translate contentKey="studentManagementApplicationApp.student.delete.question" interpolate={{ id: studentEntity.id }}>
